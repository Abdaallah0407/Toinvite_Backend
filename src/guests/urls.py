...
from .views import ExportImportExcel, APIGuestViewSet, APIGuestList, APIFileExample, APIGuestsListItemsView, \
    APIRAssylka, APIInterview, APIGuestInvitation
...
urlpatterns = [
    ...
    path('api/guest-invitation/<int:pk>', APIGuestInvitation.as_view()),
